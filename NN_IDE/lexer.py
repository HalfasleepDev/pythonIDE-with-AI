...
class PyCustomLexer(QsciLexerCustom):
    def __init__(self, parent):
        ...
        self.setDefaultFont(QFont(self.font))#prop error :(
        ...
        # font
        self.setFont(QFont("Consolas", 10, weight=QFont.Bold), self.DEFAULT)
        self.setFont(QFont("Consolas", 10, weight=QFont.Bold), self.KEYWORD)
        self.setFont(QFont("Consolas", 10, weight=QFont.Bold), self.CLASSES)
        self.setFont(QFont("Consolas", 10, weight=QFont.Bold), self.FUNCTION_DEF)
